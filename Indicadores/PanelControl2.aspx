<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PanelControl2.aspx.cs" Inherits="Indicadores_PanelControl2" %>
...
<head runat="server">
    <title></title>
    <link href="../estilos/exportar2.css" rel="stylesheet" type="text/css" />
...
">     
 ...
 <form id="form1" runat="server">
    ...
    if(tipo=="S"||tipo=="A"){%>
     ...
     %>
     <br />
    <div class="vista"> <a href="PanelControl.aspx">Ver Cuadro</a></div>
     <br />
        <div class="plantillas">
         <div class="titles" style="border-left:0 !important;">Indicador
...
<div class="corte">
         ...
         <div class="corte"><h4>Resultado</h4></div>
    ...
    <% DSRepositorioIndicadoresTableAdapters.PanelControlDAO panDAO = new DSRepositorioIndicadoresTableAdapters.PanelControlDAO();
      ...
      for (int i = 0; i < pandt.Count; i++)
      {
         ...
         <div class="plantillas <%= pandt[i].SEMAFORO=="R"?"rojo":"verde"%>">
...
<div class="corte">
         <h4> <%= pandt[i].MES %> <%= pandt[i].ANIO %> </h4>
         <h4> <%=pandt[i].REGION%> </h4>
</div>
         <div class="porcentaje corte"><%=pandt[i].IsVALORNull()?"": pandt[i].VALOR %> <%=pandt[i].IsUNIDADMEDIDANull()?"":pandt[i].UNIDADMEDIDA %></div>
