...
<FilterMenu EnableImageSprites="False"></FilterMenu>
	...
	(select DSNOMBRE from tri_rep_regiones where ID=i.IDREGION) DSREGION,(select op.DSNOMBRE from tri_rep_opciones_lista op where op.ID=i.IDPERS) PERSPECTIVA from dbo.tri_rep_indicadores i where i.IDPERD is null and
