...
<div class="fila1">
   ...
   <div class="fields">Operación <asp:DropDownList ID="ddlOperacion" runat="server" 
        ...
        </asp:DropDownList> <a class="agregarm" href="javascript:AgregarNodo('IN1','A4@149')"><h5></h5></a></div>
   ...
   <div class="fields">Línea <asp:DropDownList ID="ddlLinea" runat="server" AutoPostBack="True" onselectedindexchanged="ddlLinea_SelectedIndexChanged">
        ...
        <%if (IsAdmin())
          ...
          <div class="fields"><a href="javascript:agregarMatriz()"><img src="https://www.conectandonosconlaestrategia.com/images/mas.png" /></a></div>
...
<div class="fila1 resultado">
   ...
   function fnCambioValor2(idind, esc, valor) {
      ...
      function eliminarMatriz(id) {
          if (confirm("Esta seguro que desea eliminar este indicador?")) {
              idtr = id;
              PageMethods.EliminarInd(id, OnSucceeded2, OnFailed);
          }
  }
  ...
  function OnFailed2(error) {
      ...
      alert("Ocurrio un error al eliminar el indicador");
  }
