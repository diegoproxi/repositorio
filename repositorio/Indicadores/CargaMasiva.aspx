<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CargaMasiva.aspx.cs" Inherits="Indicadores_CargaMasiva" %>
...
<div id="divCar"  runat="server">
    ...
    Comentarios
     ...
     <div>
    Escenario<asp:DropDownList ID="ddlEscenario" runat="server"  class="validate[required]">
         </asp:DropDownList>

        
    </div>
     <div>
       Desde<asp:DropDownList ID="ddlDesde" runat="server"  class="validate[required]">
         </asp:DropDownList>
     ...
     <div>
       Hasta<asp:DropDownList ID="ddlHasta" runat="server"  class="validate[required]">
         </asp:DropDownList>
    ...
    <div>
     ...
     <div>
         ...
         <asp:CheckBox ID="chkRestr" runat="server" Text="Actualización Masiva (Sin restricciones?)" />
