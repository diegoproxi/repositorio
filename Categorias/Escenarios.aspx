<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Escenarios.aspx.cs" Inherits="Categorias_Escenarios" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:CheckBoxList ID="chklEscenarios" runat="server" RepeatColumns="2" 
            RepeatDirection="Horizontal" ondatabinding="chklEscenarios_DataBinding" 
            ondatabound="chklEscenarios_DataBound"  class="text_left zebra" border="0" >
        </asp:CheckBoxList>
